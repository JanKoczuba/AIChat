...
struct ActiveABTestsTests {
    ...
    func testEventParameters() async throws {
        ...
        #expect(params["test_202507_CreateAccTest"] as? Bool == randomCreateAccountTest)
        #expect(params["test_202507_OnbCommunityTest"] as? Bool == randomOnboardingCommunityTest)
        #expect(params["test_202507_CategoryRowTest"] as? String == randomCategoryRowTest.rawValue)
        #expect(params["test_202507_PaywallTest"] as? String == randomPaywallTest.rawValue)
    }
